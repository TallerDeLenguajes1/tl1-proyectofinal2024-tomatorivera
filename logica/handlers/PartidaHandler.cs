...
namespace Logica.Handlers
{
    ...
    public class SimuladorPartidoHandler
    {
        ...
        private Equipo saque;
        private Equipo contrarioSaque;
        private Rally rallyActual;
        ...
        public SimuladorPartidoHandler(Partido partido)
        {
            ...
            this.saque = partido.Local;
            this.contrarioSaque = partido.Local;

            // Genero el objeto encargado de cargar con la información de los rally
            this.rallyActual = new Rally(partido.Local.FormacionPartido!, partido.Visitante.FormacionPartido!, posesionPelota, saque.FormacionPartido!.ObtenerJugadorZona(1));
        }
        ...
        public void IniciarPartido()
        {
            ...
            {
                rallyActual.ComenzarRally();
                determinarResultadoRally();
        ...
        /// </summary>
        private void determinarResultadoRally()
        {
            switch (rallyActual.PosesionPelota)
            {
                ...
                case TipoEquipo.LOCAL:
                    if (saque.Nombre.Equals(partido.Local.Nombre))
                    {
                        ...
                        saque = partido.Visitante;
                        contrarioSaque = partido.Local;
                    }
            ...
            rallyActual.JugadorActual = saque.FormacionPartido!.ObtenerJugadorZona(1);
        }
    }
}